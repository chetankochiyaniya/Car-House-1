    ...
    <Box position="relative">
      ...
      >
        <Typography variant="h6" color="white" sx={{ fontWeight: '700' }}>Lorem ipsum dolor sit amet</Typography>
            ...
            <Button variant="contained" sx={{ backgroundColor: 'var(--red-color)', '&:hover': { backgroundColor: 'var(--btn-hover)' }, fontWeight: '500'}} onClick={()=>navigate('/contact')}>Contact Us</Button>
      </Box>
    </Box>
